...
2. **在线唯一IP阈值** - 当前在线唯一IP数超过阈值时自动重置token/uuid
...
- **检测窗口**: 默认 600 秒
- **处理策略**: 支持 `observe / throttle / empty / block / reset_token / reset_token_uuid`

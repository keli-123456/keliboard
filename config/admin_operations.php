...
return [
    ...
    'history_retention_days' => max(1, (int) env('ADMIN_OPERATION_HISTORY_RETENTION_DAYS', 30)),
    'failure_retention_days' => max(1, (int) env('ADMIN_OPERATION_FAILURE_RETENTION_DAYS', 90)),
];
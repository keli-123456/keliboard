    ...
    private function metrics(array $events, int $days, array $aggregate = []): array
    {
        ...
        return [
            ...
            'data_limits' => [
                ...
                'historical_source_events_may_be_unattributed' => true,
    ...
    private function messages(array $config, array $metrics): array
    {
        ...
        $payload = json_encode([
            ...
            'constraints' => [
                ...
                'legacy_unattributed_means_pre_attribution_history_not_unknown_origin' => true,
                'source_class_and_provider_are_parallel_dimensions' => true,
                'anonymous_rule_counts_cover_attributed_events_only' => true,

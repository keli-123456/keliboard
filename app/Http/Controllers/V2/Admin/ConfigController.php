    ...
    private function getConfigMappings(): array
    {
        ...
        return [
            ...
            'server' => [
                ...
                'subscription_control_enable' => (bool) admin_setting('subscription_control_enable', false),
                'subscription_control_online_ip_threshold' => (int) admin_setting('subscription_control_online_ip_threshold', 6),
                'subscription_control_required_windows' => (int) admin_setting('subscription_control_required_windows', 3),
                'subscription_control_window_seconds' => (int) admin_setting('subscription_control_window_seconds', 300),
                'subscription_control_cooldown_minutes' => (int) admin_setting('subscription_control_cooldown_minutes', 120),
                'subscription_control_action' => (string) admin_setting('subscription_control_action', 'reset_token'),
                'subscription_control_max_per_run' => (int) admin_setting('subscription_control_max_per_run', 100),
                'subscription_control_whitelist_user_ids' => (string) admin_setting('subscription_control_whitelist_user_ids', ''),
                'subscription_control_recent_event_limit' => (int) admin_setting('subscription_control_recent_event_limit', 500),
            ],
            'subscription_proxy' => [

...
class ConfigSave extends FormRequest
{
    const RULES = [
        ...
        'subscription_control_enable' => 'boolean',
        'subscription_control_online_ip_threshold' => 'integer|min:1|max:10000',
        'subscription_control_required_windows' => 'integer|min:1|max:120',
        'subscription_control_window_seconds' => 'integer|min:60|max:86400',
        'subscription_control_cooldown_minutes' => 'integer|min:1|max:10080',
        'subscription_control_action' => 'in:reset_token,reset_token_uuid,log_only',

...
class ConfigSave extends FormRequest
{
    const RULES = [
        ...
        'ticket_ai_auto_reply_allowed_categories' => 'nullable|array|max:8',
        'ticket_ai_auto_reply_allowed_categories.*' => 'string|in:客户端连接,订阅与节点,套餐订单,流量异常,其他',
        'ticket_ai_auto_reply_max_per_ticket' => 'nullable|integer|min:1|max:10',

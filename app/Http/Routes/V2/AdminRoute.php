    ...
    public function map(Registrar $router)
    {
        ...
        $router->group([
            ...
            $router->group([
                ...
                $router->get('/earnings-showcase', [\App\Http\Controllers\V2\Admin\EarningsShowcaseController::class, 'show']);
                ...
                $router->post('/agents/{agentUserId}/profit', [\App\Http\Controllers\V2\Admin\AgentProfitController::class, 'configure']);

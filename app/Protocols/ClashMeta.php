...
{
    public $flags = ['meta', 'mihomo', 'clashmeta', 'clash-meta', 'clash-verge', 'verge', 'flclash', 'nekobox', 'nekoray', 'sparkle', 'clashmetaforandroid', 'clashx meta', 'clashxmeta'];
    ...
    public function handle()
    {
        ...
        $template = subscribe_template('clashmeta', File::exists(base_path(self::CUSTOM_TEMPLATE_FILE))
